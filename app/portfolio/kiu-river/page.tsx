...
export default function KiuRiverProject() {
      ...
      <main className="min-h-screen bg-white text-gray-800">
        ...
        <section className="py-12 bg-[#2ebc6e]">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white">Residential Solar & Solar Water Heating Installation</h1>
            <p className="mt-3 text-base sm:text-lg text-white/90">Kiu River, Kahawa Sukari, Nairobi</p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">December 2025</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">📍</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Location</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Kiu River Rd, Nairobi</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">💼</div>
              ...
              <div className="p-6">
                <div className="aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-lg">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/4veMRN0YSvE"
                    title="Kiu River solar project video"
                    frameBorder="0"
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-4xl text-slate-600 leading-8">
              Sunware Energy Limited successfully completed a residential solar energy and solar water heating installation at Kiu River, Kahawa Sukari. The project was designed to provide the homeowner with reliable solar power and free hot water from the sun, drastically reducing electricity bills.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">System Size</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">8kW Solar PV + 5kWh Battery</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Inverter</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">8kW Hybrid Inverter</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Water Heating</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">300L Pressurized Solar Water Heater</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <p className="mt-6 text-slate-600 leading-8">Since the installation, our electricity bills have dropped by over 70%. The solar water heater is a game changer — we always have hot water now. Professional team, clean work. Highly recommend Sunware Energy!</p>
              <p className="mt-6 font-semibold text-slate-900">J. Mwangi</p>
            </div>
          </div>
        </section>
