...
export default function NandiHillsSchoolProject() {
      ...
      <main className="min-h-screen bg-white text-gray-800">
        ...
        <section className="py-12 bg-[#2ebc6e]">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="mt-3 text-base sm:text-lg text-white/90">Nandi Hills Secondary School, Kenya</p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">Nandi Hills</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">💼</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Client Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Educational Institution (Secondary School)</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">🔋</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">System Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Hybrid Solar PV System (Off-grid with KPLC backup)</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-lg">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/5u2OQJvGHXs"
                    title="Nandi Hills school project video"
                    frameBorder="0"
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-4xl text-slate-600 leading-8">
              Sunware Energy Limited was engaged to install a reliable and scalable solar energy solution for a secondary school in Nandi Hills. The objective was to reduce reliance on grid power, cut electricity costs, and ensure uninterrupted power for the school's computer lab, lighting, and administrative offices.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">System Capacity</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">10kW Hybrid Solar PV</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">System Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Off-grid with KPLC backup</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:col-span-2">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Client Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Educational Institution</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <p className="mt-6 text-slate-600 leading-8">Our electricity bills were a major burden on the school budget. Since the Sunware Energy installation, we have saved significantly every month. Our students now have reliable power for their computer lessons. Excellent work!</p>
              <p className="mt-6 font-semibold text-slate-900">School Principal</p>
            </div>
          </div>
        </section>
