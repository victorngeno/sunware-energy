...
export default function KNHHospitalProject() {
      ...
      <main className="min-h-screen bg-white text-gray-800">
        ...
        <section className="py-12 bg-[#2ebc6e]">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white">30kWh Hybrid Backup System</h1>
            <p className="mt-3 text-base sm:text-lg text-white/90">Kenyatta National Hospital, Upperhill, Nairobi</p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">August 2025</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">📍</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Location</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Upperhill, Nairobi</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">💼</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Client Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Hospital</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">🔋</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">System Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Power Backup Solution</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-lg">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/Fyh8Nsv1eKE"
                    title="KNH hospital backup system video"
                    frameBorder="0"
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-4xl text-slate-600 leading-8">
              Sunware Energy Limited was engaged to install a reliable power backup solution for a block at Kenyatta National Hospital. The objective was to ensure that in case of a blackout, critical medical machines in the block would continue operating without interruption, protecting patient care.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Battery Backup</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">30kWh Hybrid System</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <p className="mt-6 text-slate-600 leading-8">In a hospital environment, power reliability is not optional — it is critical. Sunware Energy delivered a backup system that gives us complete confidence. The installation was handled professionally with minimal disruption to hospital operations.</p>
              <p className="mt-6 font-semibold text-slate-900">Facilities Manager, KNH</p>
            </div>
          </div>
        </section>
