...
export default function LangataWaterPumpingProject() {
      ...
      <main className="min-h-screen bg-white text-gray-800">
        ...
        <section className="py-12 bg-[#2ebc6e]">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white">Solar Water Pumping System Installation</h1>
            <p className="mt-3 text-base sm:text-lg text-white/90">Langata, Nairobi</p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">November 2025</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">📍</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Location</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Langata, Nairobi</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">💼</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Client Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Business Enterprise</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">🔋</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">System Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">15 kWp PV + 11 kW Solar Pump Inverter</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-lg">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/oWzTBRIu8hs"
                    title="Langata water pumping project video"
                    frameBorder="0"
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-4xl text-slate-600 leading-8">
              Sunware Energy Limited completed a solar water pumping upgrade for a business client in Langata. The client already had a functioning borehole and pump, and required a solar solution to eliminate the high electricity costs of running the pump on grid power.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Solar Array</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">15 kWp PV</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Solar Pump Inverter</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">11 kW</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:col-span-2">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Client Status</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Existing borehole & pump already installed</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <p className="mt-6 text-slate-600 leading-8">We were spending a fortune running our borehole pump on KPLC. Since switching to solar, our water pumping costs have virtually disappeared. The system has been running flawlessly. Great investment!</p>
              <p className="mt-6 font-semibold text-slate-900">P. Kamau</p>
            </div>
          </div>
        </section>
