...
export default function MigoriProject() {
      ...
      <main className="min-h-screen bg-white text-gray-800">
        ...
        <section className="py-12 bg-[#2ebc6e]">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white">12kW Residential Hybrid Solar System</h1>
            <p className="mt-3 text-base sm:text-lg text-white/90">Migori, Kenya</p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">September 2025</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">📍</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Location</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Migori, Kenya</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">💼</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">Client Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Residential Home</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-5 border border-slate-200">
                  <div className="text-2xl">🔋</div>
                  <p className="mt-4 text-sm text-slate-500 uppercase tracking-[0.25em]">System Type</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">Off-grid/Hybrid Solar + Battery Backup</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="aspect-video w-full overflow-hidden rounded-3xl bg-black shadow-lg">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/VpDZiJ_QeEw"
                    title="Migori solar project video"
                    frameBorder="0"
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-4xl text-slate-600 leading-8">
              Sunware Energy Limited designed and installed a hybrid solar system for a residential client in Migori. The system ensures continuous power supply, reduces reliance on the grid, and provides backup during outages. The system also powers a small shop adjacent to the residence.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <p className="mt-2 text-lg font-semibold text-slate-900">12kW Hybrid Inverter</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Solar Panels</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">8 kWp Solar Panel Array</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Battery Bank</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">18.36 kWh Lithium-Ion</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Accessories</p>
                  <p className="mt-2 text-lg font-semibold text-slate-900">BOS components including isolators, surge protection, monitoring system</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-12">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="rounded-3xl border border-slate-200 p-8 shadow-sm">
              ...
              <p className="mt-6 text-slate-600 leading-8">Living in Migori, grid power is unreliable. Sunware Energy installed a system that powers our entire home and small shop. We no longer worry about blackouts. The team was professional, punctual and the work was very clean.</p>
              <p className="mt-6 font-semibold text-slate-900">S. Odhiambo</p>
            </div>
          </div>
        </section>
